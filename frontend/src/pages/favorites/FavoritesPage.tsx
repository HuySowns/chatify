				...
				<div className='relative min-h-full pb-20'>
					...
					<div className='relative z-10'>
						<div className='flex p-6 gap-6 pb-8'>
							<div className='w-[240px] h-[240px] shadow-xl rounded bg-gradient-to-br from-indigo-700 to-indigo-300 flex items-center justify-center'>
								<Heart className='size-20 text-white' fill='white' />
							</div>
							<div className='flex flex-col justify-end'>
								<p className='text-sm font-medium'>Playlist</p>
								<h1 className='text-7xl font-bold my-4'>Liked Songs</h1>
								<p className='text-sm text-zinc-100'>{favoriteSongs.length} songs</p>
							</div>
						</div>
                      ...
                      text-zinc-400 hover:bg-white/5 rounded-md group cursor-pointer`}
											>
												...
												<div className='flex items-center gap-4'>
													...
													>
														<Heart className='size-4 fill-green-500 text-green-500' />
													</button>
